...
if (!defined('APP_NAME'))
  define('APP_NAME', 'MAPATURO');
if (!defined('APP_ORGANIZATION'))
  define('APP_ORGANIZATION', 'GROUPNAME');
if (!defined('APP_OWNER'))
  define('APP_OWNER', 'DEVELOPERS');
if (!defined('APP_DESCRIPTION'))
  define('APP_DESCRIPTION', 'GEOGRAPHIC LEARNING WEBAPP');

if (!defined('ALLOWED_INACTIVITY_TIME'))
  define('ALLOWED_INACTIVITY_TIME', time() + 1 * 60);

if (!defined('DB_DATABASE'))
  define('DB_DATABASE', 'mapaturo');
if (!defined('DB_HOST'))
